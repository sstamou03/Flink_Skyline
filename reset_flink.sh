...
docker exec kafka kafka-topics --create --topic Input --bootstrap-server kafka:29092 --partitions 1 --replication-factor 1
...
docker cp "/home/giorgos/Documents/Flink_Skyline/out/artifacts/FlinkSkyline_jar/FlinkSkyline.jar" jobmanager:/job.jar
